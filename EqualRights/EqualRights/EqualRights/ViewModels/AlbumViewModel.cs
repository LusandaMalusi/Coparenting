...
namespace EqualRights.ViewModels
{
    ...
    {
        private ObservableCollection<Imi> _monkeys;
        public ObservableCollection<Imi> Monkeys
        {
            get { return _monkeys; }
        ...
        public AlbumViewModel(INavigationService navigationService) : base(navigationService)
        {
        }
        ...
        void PopulateMonkeys()
        {
            ...
            Monkeys = new ObservableCollection<Imi>(Imis);
        }
    }
}
